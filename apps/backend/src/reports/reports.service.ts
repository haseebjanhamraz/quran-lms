      ...
      return new Promise((resolve, reject) => {
         try {
            ...
            doc.fillColor('#C9A84C')
               .font('Helvetica-Bold')
               .fontSize(22)
               .text('Ain Ul Quran COMPLIANCE PORTAL', 50, 30);
            ...
            doc.fillColor('#94a3b8')
               .font('Helvetica')
               .fontSize(8)
               .text('Generated automatically by Ain Ul Quran Quality Auditing Engine. Confidential Audit Document.', 50, bottomY, { align: 'center', width: 500 });
