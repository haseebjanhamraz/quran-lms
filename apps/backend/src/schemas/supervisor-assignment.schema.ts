...
SupervisorAssignmentSchema.index({ supervisorId: 1, teacherId: 1 });
SupervisorAssignmentSchema.index({ supervisorId: 1, courseId: 1 });
...
SupervisorAssignmentSchema.virtual('teacher', {
  ref: 'User',
