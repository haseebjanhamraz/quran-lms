  ...
  return (
    <div className="max-w-4xl animate-fadeIn">
      <div className="mb-8">
        ...
        <p className="text-sm text-slate-400 mt-1">Configure global platform behavior.</p>
      </div>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden">
        <div className="p-6 border-b border-slate-800/60">
          <h2 className="text-lg font-semibold text-slate-200">AI Quality Analysis</h2>
          <p className="text-sm text-slate-500 mt-1">Control whether class recordings are automatically analyzed by AI for compliance and quality.</p>
        </div>
        ...
        <div className="p-6 space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1">If enabled, transcripts will be analyzed automatically after class ends.</p>
            </div>
            <button
              type="button"
        ...
        <div className="p-6 border-t border-slate-800/60 bg-slate-900/50 flex justify-end">
          <button
            onClick={handleSave}
            disabled={saving}
            className="flex items-center gap-2 bg-[#C9A84C] hover:bg-[#b5953e] disabled:opacity-50 text-slate-900 font-bold py-2 px-6 rounded-xl transition-colors"
          >
