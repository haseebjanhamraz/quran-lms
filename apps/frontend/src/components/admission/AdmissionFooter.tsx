    ...
    <div className="shrink-0 bg-card/95 backdrop-blur-xl border-t border-border/80 px-4 sm:px-8 md:px-12 py-3.5 flex items-center justify-between shadow-lg z-20">
      ...
      {step < totalSteps ? (
        <button
          type="button"
          onClick={onNext}
          className="flex items-center gap-1.5 bg-primary hover:bg-primary/90 text-primary-foreground py-2.5 px-6 rounded-xl text-sm font-bold shadow-md hover:shadow-lg transition-all"
        >
        ...
        <button
          type="submit"
          disabled={submitting}
          className="flex items-center gap-2 bg-primary hover:bg-primary/90 text-primary-foreground py-2.5 px-8 rounded-xl text-sm font-bold shadow-xl hover:shadow-2xl transition-all disabled:opacity-50"
        >
